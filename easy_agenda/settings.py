"""
Django settings for easy_agenda project.
...
WSGI_APPLICATION = 'easy_agenda.wsgi.application'
...
# change the authentication for the custom authentication model
